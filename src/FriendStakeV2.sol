...
import {IterableMapping} from "./lib/IterableMappingV2.sol";
...
contract FriendStake is Initializable, OwnableUpgradeable, ERC1155HolderUpgradeable {
    ...
    /// @dev Modifier to ensure only the authority or owner can call certain functions
