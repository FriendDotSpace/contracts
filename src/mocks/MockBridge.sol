...
contract MockBridge is Ownable, IDlnSource {
    ...
    function createSaltedOrder(
        ...
        bytes32 orderId =
            keccak256(abi.encodePacked(msg.sender, _salt, _orderCreation.giveTokenAddress, _orderCreation.giveAmount));
     ...
     */
    function _processOrder(DlnOrderLib.OrderCreation calldata _orderCreation, bytes32 orderId) internal {
