...
contract MockFriendKey {
    ...
    function registerCreator(IFriendKey.RoomTier /* tier */, uint256 /* additionalKeys */, string calldata /* metadata */, bytes calldata /* signature */) external returns (uint256) {
        return ++_nextTokenId;
    }
...
contract FriendRoomManagerTest is Test {
    ...
    function setUp() public {
        ...
        address roomManagerProxy = Upgrades.deployUUPSProxy(
    ...
    function testCheckAndUpdateRoomRegistration() public {
        ...
        roomManager.checkAndUpdateRoomRegistration(
            creator,
            IFriendKey.RoomType.Trading,
            IFriendKey.RoomTier.Club,
            1
        );
    ...
    function testGetCreatorRooms() public {
        ...
        uint256[] memory rooms = roomManager.getCreatorRooms(creator, IFriendKey.RoomType.Social, IFriendKey.RoomTier.Club);
