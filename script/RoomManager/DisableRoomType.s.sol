...
/**
 * @title DisableRoomTypeScript
 * @notice Disables a room type/tier (sets limit to 0) in RoomManager
 */
contract DisableRoomTypeScript is Script {
    ...
    function run() public {
        ...
        mgr.disableRoomType(roomType, tier);
        console2.log("Disabled room type %s tier %s", uint256(roomType), uint256(tier));
