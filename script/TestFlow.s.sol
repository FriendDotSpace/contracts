...
contract TestFlowScript is Script {
    ...
    function run() public {
        ...
        friendKeyProxy = 0x295577574FDc19EF2EbC4437462E2F5044591D14; // testnet
        ...
        console2.log("=== Friend.space Protocol Test Flow ===");
        ...
        bytes32 REGISTER_CREATOR_TYPEHASH = keccak256(
            "RegisterCreator(address account,uint8 tier,uint256 additionalKeys,uint256 nonce,string metadata)"
        );
        ...
        friendKey.buyShares(tokenId, sharesToBuy);
        ...
        friendKey.sellShares(tokenId, sharesToSell);
